...
void GoblinsQueue::DoAdditionRequest(int number_of_goblin) {
  if (count % 2 == 1) {
...
void GoblinsQueue::DoMultiplicationRequest(int number_of_goblin) {
  if (count % 2 == 1) {
...
void GoblinsQueue::DoInput(char type_of_input) {
  if (type_of_input == '+') {
